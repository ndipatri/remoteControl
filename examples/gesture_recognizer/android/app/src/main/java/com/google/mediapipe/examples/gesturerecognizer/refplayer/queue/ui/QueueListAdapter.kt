 ...
 */
package com.google.mediapipe.examples.gesturerecognizer.refplayer.queue.ui
...
import com.google.mediapipe.examples.gesturerecognizer.refplayer.queue.QueueDataProvider
import com.google.mediapipe.examples.gesturerecognizer.refplayer.utils.CustomVolleyRequest
...
class QueueListAdapter(
    ...
    override fun onBindViewHolder(holder: QueueItemViewHolder, position: Int) {
        ...
        if (imageUrl != null) {
            ...
            holder.mProgressLoading.postDelayed({
                holder.mProgressLoading.visibility = View.GONE
                holder.mImageView.setDefaultImageResId(com.google.android.gms.cast.framework.R.drawable.cast_album_art_placeholder)
                holder.mImageView.setImageResource(com.google.android.gms.cast.framework.R.drawable.cast_album_art_placeholder)
            }, 3000)
        }
    ...
    class QueueItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        fun updateControlsStatus(@ControlStatus status: Int) {
            ...
            mTitleView.setTextAppearance(mContext, androidx.appcompat.R.style.Base_TextAppearance_AppCompat_Subhead)
            mDescriptionView.setTextAppearance(
                mContext,
                androidx.appcompat.R.style.Base_TextAppearance_AppCompat_Caption
            )
            ...
            when (status) {
                ...
                UPCOMING -> {
                    ...
                    mTitleView.setTextAppearance(
                        mContext,
                        androidx.appcompat.R.style.TextAppearance_AppCompat_Small_Inverse
                    )
                    mTitleView.setTextAppearance(
                        mTitleView.context,
                        androidx.appcompat.R.style.Base_TextAppearance_AppCompat_Subhead_Inverse
                    )
                    mDescriptionView.setTextAppearance(
                        mContext,
                        androidx.appcompat.R.style.Base_TextAppearance_AppCompat_Caption
